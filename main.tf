...
resource "aws_subnet" "private" {
  ...
  tags                    = { Name = "demo-private-${local.azs_names[count.index]}" }
}
...
resource "aws_nat_gateway" "main" {
  ...
  tags = {
    Name    = "demo-nat-${local.azs_names[count.index]}"
...
resource "aws_launch_template" "ecs_ec2" {
  ...
  image_id               = "ami-09f63ae8e9b15e9b2" #data.aws_ssm_parameter.ecs_node_ami.value
